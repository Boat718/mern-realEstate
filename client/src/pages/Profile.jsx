...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 className='text-3xl font-semibold text-center my-7'>Prfoile</h1>
        <form className='flex flex-col gap-4' >
          ...
          <input type="password" onChange={handleChange} defaultValue={currentUser.password} placeholder='password' id='password' className='border p-3 rounded-lg' />
          <button onClick={handleSubmit} disabled={loading} className='bg-slate-700 text-white rounded-lg p-3
          ...
          rounded-lg uppercase text-center hover:opacity-95 '> Create Listing</Link>
        </form>
            ...
            <div className='flex flex-col gap-4'>
              ...
              {userListing.map((listing) => 
                <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4' >
                  ...
                  <Link  to={`/listing/${listing._id}`} className=' text-slate-700 font-semibold flex-1 
